...
<?php foreach($film as $f) { ?>
	<div class="list" title="FILM <?= strtoupper($f['judul']); ?>">
		...
		?>
			<a href="view.php= $f['id']; ?>" style="color: white;text-decoration: none;" >
				<?= strtoupper($f['judul']); ?>
			</a>
		</p>
		<br>
		<a href="view.php= $f['id']; ?>" class="view">Detail</a>
	</div>
<?php } ?>
<br>
<br>
<br>
<?php if(!isset($_SESSION['login'])) { ?>
	<a href="login.php" class="logtoview"><i class="fa fa-sign-in-alt"></i> &nbsp;Login untuk melihat semua film</a>
<?php } else { ?>
	<a href="movies.php" class="logtoview"><i class="fa fa-arrow-alt-circle-right"></i> Lihat Semua Film <i class="fa fa-arrow-alt-circle-right"></i></a>
<?php } ?>
<br>
<br>
<br>
